...
- Clear the list to start a new job — a "Clear List" button (with a confirm step, so it can't happen by accident) resets everything back to empty, ready for the next work order.
